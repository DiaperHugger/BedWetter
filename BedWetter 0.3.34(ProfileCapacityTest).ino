/*BedWETTER v0.3.34  Updated 7/3/21
...
void EEPROM_RECALL() //EEPROM address layout tied to MenuPosition!  +10 per row.
{
  ...
  PROFILEVar[0].Heavy = EEPROM.read(31);
  PROFILEVar[0].Spurts = EEPROM.read(32);
  PROFILEVar[0].Damp = EEPROM.read(33);
  PROFILEVar[0].Dry = EEPROM.read(34);
  PROFILEVar[0].Capacity = EEPROM.read(35);
  PROFILEVar[0].FlowRate = EEPROM.read(36);
...
void LCDDisplayData() //MenuPosition = ROW,COLUMN
{
    ...
    else if ((MenuPosition == 31) && (MenuPosition != LastMenuPosition)) //Profile Heavy
    {
      ProfileDistributionCheck();
      lcd.setCursor(0, 1);
      lcd.print(F("                "));
    ...
    else if ((MenuPosition == 32) && (MenuPosition != LastMenuPosition)) //Profile Spurts
    {
      ProfileDistributionCheck();
      lcd.setCursor(0, 1);
      lcd.print(F("                "));
    ...
    else if ((MenuPosition == 33) && (MenuPosition != LastMenuPosition)) //Profile Damp
    {
      ProfileDistributionCheck();
      lcd.setCursor(0, 1);
      lcd.print(F("                "));
    ...
    else if ((MenuPosition == 34) && (MenuPosition != LastMenuPosition)) //Profile Dry
    {
      ProfileDistributionCheck();
      lcd.setCursor(0, 1);
      lcd.print(F("                "));
    ...
    else if ((MenuPosition == 35) && (MenuPosition != LastMenuPosition)) //Profile Capacity
    {
      lcd.setCursor(0, 1);
      lcd.print(F("                "));
      lcd.setCursor(0, 1);
      ...
      lcd.print(F("000"));
      lcd.setCursor(13, 1);
      if(PROFILEVar[0].Capacity > 9)
      {
        lcd.setCursor(12, 1);
      }
      lcd.print(PROFILEVar[0].Capacity);
      Cursor = 0;
      SPECIAL = 1;
      LastMenuPosition = MenuPosition;
    }
    else if ((MenuPosition == 36) && (MenuPosition != LastMenuPosition)) //Profile FlowRate
    {
      lcd.setCursor(0, 1);
      lcd.print(F("                "));
      lcd.setCursor(0, 1);
      ...
      lcd.print(F("0"));
      lcd.setCursor(14, 1);
      if(PROFILEVar[0].FlowRate > 9)
      {
        lcd.setCursor(13, 1);
      }
      lcd.print(PROFILEVar[0].FlowRate);
      Cursor = 0;
      SPECIAL = 1;
      LastMenuPosition = MenuPosition;
    }
...
void ALTERNATE()
{
  ...
  if(MenuPosition == 22)//Wet Intervals
  {
    if(LastButtonPress == 2)//UP
      {
        CurrentVal++;
  ...
  if(MenuPosition == 31)//Profile Heavy
  {
      ProfileDistributionLimit();
      PROFILEVar[0].Heavy = CurrentVal;
  }
  if(MenuPosition == 32)//Profile Spurts
  {
      ProfileDistributionLimit();
      PROFILEVar[0].Spurts = CurrentVal;
  }
  if(MenuPosition == 33)//Profile Damp
  {
      ProfileDistributionLimit();
      PROFILEVar[0].Damp = CurrentVal;
  }
  if(MenuPosition == 34)//Profile Dry
  {
      ProfileDistributionLimit();
      PROFILEVar[0].Dry = CurrentVal;
  }
  if(MenuPosition == 35)//Profile Capacity
  {
    if(LastButtonPress == 2)//UP
      {
        CurrentVal++;
      ...
      PROFILEVar[0].Capacity = CurrentVal;
  }
  if(MenuPosition == 36)//Profile FlowRate
  {
    if(LastButtonPress == 2)//UP
      {
        CurrentVal++;
      ...
      PROFILEVar[0].FlowRate = CurrentVal;
  }
...
void FLOOD()
{
  ...
  {
    float FloodLow = (Duration - (Duration * FloodMargin));
    float FloodHigh = (Duration + (Duration * FloodMargin));
    //float FloodHigh = Duration;
  ...
  Serial.println(PROFILEVar[0].Capacity * 100);
  Serial.print(F("Capacity Margin/ml: "));
  Serial.println(AdjCapacity * 100);
  Serial.print(F("Nominal Duration: "));
  Serial.print(Duration);
  Serial.print(F(" +/- "));
  Serial.print((FloodMargin * 100), 0);
  Serial.println(F("%"));
  Serial.print(F("Flow Rate: "));
  Serial.print(PROFILEVar[0].FlowRate * 10);
...
void HEAVY()
{
  ...
  for (int i = (ProfileIntervals - 1); i >= 0; i--)
  {
    float HeavyLow = (Duration - (Duration * HeavyMargin));
    float HeavyHigh = (Duration + (Duration * HeavyMargin));
  ...
  Serial.print(Duration);
  Serial.print(F(" +/- "));
  Serial.print((HeavyMargin * 100), 0);
  Serial.println(F("%"));
  Serial.print(F("Flow Rate: "));
  Serial.print(PROFILEVar[0].FlowRate * 10);
  Serial.println(F("ml/min"));
...
void SPURTS()
{
  ...
  for (int i = (ProfileIntervals - 1); i >= 0; i--)
  {
    float SpurtsLow = (Duration - (Duration * SpurtsMargin));
    float SpurtsHigh = (Duration + (Duration * SpurtsMargin));
  ...
  Serial.print(Duration);
  Serial.print(F(" +/- "));
  Serial.print((SpurtsMargin * 100), 0);
  Serial.println(F("%"));
  Serial.print(F("Flow Rate: "));
  Serial.print(PROFILEVar[0].FlowRate * 10);
  Serial.println(F("ml/min"));
...
void DAMP()
{
  ...
  for (int i = (ProfileIntervals - 1); i >= 0; i--)
  {
    float DampLow = (Duration - (Duration * DampMargin));
    float DampHigh = (Duration + (Duration * DampMargin));
